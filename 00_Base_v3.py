...
while want_order == "":
    ...
    # Add the pizza cost and topping cost to the total
    total_cost += cost + topping_cost

    user_order.append(user_order_name)
    all_size_pizza.append(size_pizza)
    all_pizza_cost.append(currency(cost))
    all_topping.append(topping_order_name)
    all_topping_price.append(currency(topping_cost))
    all_order_totals.append(currency(cost + topping_cost))
